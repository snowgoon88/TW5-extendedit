...
** TODO [1/6] essayer dans framed.js
*** TODO BUG : tient pas compte des CSS
**** CSS
element {
    display: block;
    position: absolute;
...
*** TODO BUG : les items dans le popup n'ont pas le bon style
*** TODO BUG : le popup est limité par la taille du iframe (coupé en bas)
*** TODO BUG : les flèches ne marchent pas
*** TODO POSS : popup hors du iframe mais avec offset ?
