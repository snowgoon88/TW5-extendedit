...
var CompMod = function( editWidget, areaNode, param ) {
    ...
    /**
     * Display someNode at the cursor.
     */
 ...
 */
CompMod.prototype.handleKeydown = function(event) {
    // key 
 ...
 */
CompMod.prototype.handleInput = function(event) {
    this._hasInput = true;
 ...
 */
CompMod.prototype.handleKeypress = function(event) {
 ...
 */
CompMod.prototype.handleKeyup = function(event) {
    var curPos = this._areaNode.selectionStart;  // cursor position
    var val = this._areaNode.value;   // text in the area
    // key a
    var key = event.keyCode;
